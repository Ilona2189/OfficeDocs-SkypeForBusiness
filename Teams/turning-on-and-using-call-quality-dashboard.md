...
> If customer's Skype On-Premises users are involved in federated calls with SfB Online users, the customer can see the telemetry generated by these calls in CQD Online with the same SIP domain.
